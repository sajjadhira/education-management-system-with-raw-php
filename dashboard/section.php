...
<h1 class="title text-center"><?php _e($head['title']) ?></h1>
                  <div class="x_title">
					...
					<li><a href="<?php echo base_url(); ?>dashboard/add-section/"><button type="button" class="btn btn-primary btn-xs">Add Section</button></a></li>
					<li><a href="<?php echo base_url(); ?>dashboard/manage-section/"><button type="button" class="btn btn-primary btn-xs">Manage Section</button></a></li>
                      </li>
                    </ul>
...
$exists = $db->where ('name',$name)->where ('class',$class)->has ('section');
/** Values **/
if (strlen($name)<1)
{
echo '<div class="alert alert-danger text-center">';
echo 'Please type a valid section name!';
echo '</div>';
}
else if (strlen($title)<1)
{
echo '<div class="alert alert-danger text-center">';
echo 'Please type a valid section title!';
echo '</div>';
}
else if ($class<1)
{
...
$query = $db->insert ('section', $data);
if ($query)
{
echo '<div class="alert alert-success text-center">';
echo '<span class="glyphicon glyphicon-ok-circle"></span> Section has been added successfully!';
echo '</div>';
}
else
{
...
<form method="post" enctype="multipart/form-data" >
				  ...
				  <div class="row">
                    ...
                    <div class="col-md-11 col-sm-11 col-xs-12">
                      <input type="text" name="name" class="form-control" placeholder="A" autocomplete="off">
                    </div>
                  </div>
                  </div>
                  <div class="form-group">
				  <div class="row">
                    ...
                    <div class="col-md-11 col-sm-11 col-xs-12">
                      <input type="text" name="title" class="form-control" placeholder="Green" autocomplete="off">
                    </div>
                  </div>
                  </div>
                  <div class="form-group">
          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Manage <small>Section</small></h3>
              </div>
...
echo '<table class="table table-striped projects">
                      ...
                      <tbody>';					 
$sections = $db->where('class',$class->class)->ObjectBuilder()->get("section");
...
echo '<td>'.getvalue('id',$section->teacher,'users','name').'</td>';
echo '<td><a href="'.base_url().'dashboard/section.php?action=edit&amp;id='.$section->id.'" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i> Edit </a>
                            <a onclick="return confirm(\'Are you sure you want to delete this class?\');" href="'.base_url().'dashboard/section.php?action=delete&amp;id='.$section->id.'" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i> Delete </a></td>';
echo '</tr>';
}
echo ' 
                      </tbody>
...
$exists = $db->where ('id',$id)->has ('section');
/** Values **/
if (strlen($name)<1)
{
echo '<div class="alert alert-danger text-center">';
...
$query = $db->where('id',$id)->update ('section', $data);
if ($query)
{
echo '<div class="alert alert-success text-center">';
echo '<span class="glyphicon glyphicon-ok-circle"></span> Section has been updated successfully!';
echo '</div>';
}
else
{
...
default:
{
$result = $db->where ('id', $id)->ObjectBuilder()->getOne("section");
?>
<form method="post" enctype="multipart/form-data" >
                  <div class="form-group">
				  <div class="row">
				  ...
				  <div class="row">
                    <label class="control-label col-md-1 col-sm-1 col-xs-12">Title</label>
                    <div class="col-md-11 col-sm-11 col-xs-12">
                      <input type="text" name="title" class="form-control" placeholder="Green" value="<?php _e($result->title) ?>" autocomplete="off">
                    </div>
                  </div>
                  </div>
                  <div class="form-group">
...
<div class="ln_solid"></div>
<?php
if($db->where('id', $id)->delete('section'))
{
echo '<div class="alert alert-success text-center">';
